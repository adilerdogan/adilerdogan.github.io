export default function Hizmetler() {
  const services = [
    ...
    },
    {
      ...
      description: "Online mağazanızı profesyonel bir şekilde kuruyoruz.",
      icon: (
        <svg className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Sosyal medya ve online reklamcılık hizmetleri sunuyoruz.",
      icon: (
        <svg className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "Teknik Destek",
      description: "7/24 teknik destek ve bakım hizmetleri sağlıyoruz.",
      icon: (
        <svg className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
